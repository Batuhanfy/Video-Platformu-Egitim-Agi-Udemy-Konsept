        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    yildizortalamasi = table.Column<double>(type: "float", nullable: false),
                    ...
                    videoshortadress = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Videolar", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Videolar_Kategoriler_CategoryId",
